...
export interface ReviewsContent {
  title: string;
  /** Заголовок формы «Оставить отзыв». */
  formTitle: string;
  /** Подпись над выбором оценки. */
  ratingLabel: string;
  /** Подсказка в поле «Имя». */
  namePlaceholder: string;
  /** Подсказка в поле «Текст отзыва». */
  ...
  successTitle: string;
  /** Текст сообщения об успехе (про модерацию). */
  successText: string;
  /** Подпись под формой про модерацию. */
...
export const DEFAULT_CONTENT: HomeContent = {
  seo: {
    brandName: "Обзор71",
    title:
      "Обзор71 — установка и обслуживание домофонов в Богородицке, Щёкино и Ефремове",
    description:
      "Обзор71 (ИП Бухтеев) — домофонная служба в Тульской области: установка и обслуживание домофонов и видеодомофонов в Богородицке, Щёкино, Ефремове. Выезд мастера, гарантия. ☎ +7 (905) 629-87-08",
    keywords:
      "домофон, установка домофона, обслуживание домофона, видеодомофон, домофонная служба, Обзор71, обзор 71, ИП Бухтеев, домофон Богородицк, домофон Щёкино, домофон Ефремов, Тульская область",
  },
  header: {
  ...
  reviews: {
    ...
    textPlaceholder: "Расскажите, как прошла работа — что понравилось, что можно улучшить",
    submitLabel: "Отправить отзыв",
    submittingLabel: "Отправляем…",
    successTitle: "Спасибо за отзыв!",
    successText:
      "Отзыв появится на сайте после проверки — обычно в течение одного рабочего дня.",
    moderationNote: "Отзывы публикуются после модерации. Мы не публикуем рекламу и оскорбления.",
  },
  coverage: {
    mode: "seo-only",
    title:
      "Установка и обслуживание домофонов в Богородицке, Щёкино и Ефремове",
    subtitle:
      "ИП Бухтеев — домофонная служба в Тульской области. Устанавливаем и обслуживаем домофоны, видеодомофоны и подъездные домофонные системы — от квартирной трубки до вызывной панели на подъезде.",
    cities: [
      {
        name: "Богородицк",
        note: "Установка и обслуживание домофонов, выезд мастера по городу и району",
      },
      {
        name: "Щёкино",
      ...
      {
        name: "Ефремов",
        note: "Обслуживание домофонных систем, выезд мастера",
      },
    ],
    morePrefix:
  ...
  footer: {
    ...
    companyDescription:
      "Профессиональная установка и обслуживание домофонных систем с гарантией качества.",
    ...
    contactsLinks: [{ label: "+7 (905) 629-87-08", href: "tel:+79056298708" }],
    copyrightText:
...
export const HOME_SECTIONS: {
  ...
  },
  {
    ...
    title: "Отзывы",
    description:
      "Заголовки блока и подписи формы. Сами отзывы клиенты оставляют на сайте, а вы публикуете их в админке (вкладка «Отзывы»).",
  },
  {
    key: "coverage",
    title: "Города работы",
