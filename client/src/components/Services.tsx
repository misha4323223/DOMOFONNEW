  ...
  const services = [
    {
      ...
      description: "Профессиональный монтаж современных домофонных систем любой сложности. Гарантия качества и надежности.",
      features: [
        "Видеодомофоны",
        "Аудиодомофоны",
        "IP-домофоны",
    ...
    },
    {
      ...
      description: "Быстрое устранение неисправностей и профилактическое обслуживание домофонного оборудования.",
      features: [
