...
const FIELD_LABELS: Record<string, string> = {
  ...
  "reviews.title": "Заголовок блока",
  "reviews.formTitle": "Заголовок формы «Оставить отзыв»",
  "reviews.ratingLabel": "Подпись над выбором оценки",
  "reviews.namePlaceholder": "Подсказка в поле «Имя»",
  "reviews.textPlaceholder": "Подсказка в поле «Текст отзыва»",
  "reviews.submitLabel": "Кнопка «Отправить отзыв»",
  "reviews.submittingLabel": "Кнопка во время отправки",
  "reviews.successTitle": "Заголовок «Спасибо за отзыв»",
  "reviews.successText": "Текст после отправки (про модерацию)",
  "reviews.moderationNote": "Подпись под формой про модерацию",
