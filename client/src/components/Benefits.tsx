  ...
  const benefits = [
    {
      ...
      description: "Все работы выполняются с гарантией. Используем только сертифицированное оборудование."
    },
    {
      icon: Clock,
      title: "Быстрое реагирование",
      description: "Оперативный выезд специалиста. Большинство неисправностей устраняем в день обращения."
    },
    {
      icon: Award,
      title: "Опытные мастера",
      description: "Наши специалисты имеют многолетний опыт работы с различными домофонными системами."
    }
  ];
